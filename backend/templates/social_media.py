    ...
    while retries < max_retries:
        try:
            ...
            response = client.models.generate_content(
                ...
                contents=f"Generate 5 social media post for {description}. Return a clean JSON array where each object has 'title' and 'description'. No extra text, no numbers, no markdown, no code blocks."
            )
