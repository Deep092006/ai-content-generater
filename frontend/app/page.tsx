  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="ContentAI helps you generate high-quality content using advanced AI models." />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white flex flex-col items-center justify-center p-6">
        ...
        <p className="mt-4 text-lg text-gray-300 max-w-2xl text-center animate-fade-in-up">
          Create high-quality, engaging content effortlessly with the power of AI. Let ContentAI AI generate blog posts, articles, and more for you.
        </p>
